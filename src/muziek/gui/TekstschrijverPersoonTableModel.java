...
public class TekstschrijverPersoonTableModel extends AbstractTableModel {
    final Logger logger = Logger.getLogger( TekstschrijverPersoonTableModel.class.getCanonicalName() );

    private Connection connection;
    private String[ ] headings = { "Tekstschrijver-Persoon" };

    private class TekstschrijverRecord {
        int	persoonId;
        String  persoonString;

        TekstschrijverRecord( int    persoonId,
                              String persoonString ) {
    ...
    private ArrayList<TekstschrijverRecord> tekstschrijverRecordList = new ArrayList<>( 10 );
    ...
    public Object getValueAt( int row, int column ) {
        ...
        return ( tekstschrijverRecordList.get( row ) ).persoonString;
    }
    ...
    public void setValueAt( Object object, int row, int column ) {
        ...
        final TekstschrijverRecord tekstschrijverRecord = tekstschrijverRecordList.get( row );
        ...
        updateString = "UPDATE persoon SET " + updateString + " WHERE persoon_id = " + tekstschrijverRecord.persoonId;
    ...
    public int getPersoonId( int row ) {
        ...
        return ( tekstschrijverRecordList.get( row ) ).persoonId;
    }
    ...
    private void insertTable( ) {
        ...
        try {
            ...
            for ( int tekstschrijverIndex = 0; tekstschrijverIndex < tekstschrijverRecordList.size( ); tekstschrijverIndex++ ) {
                int persoonId = ( tekstschrijverRecordList.get( tekstschrijverIndex ) ).persoonId;
